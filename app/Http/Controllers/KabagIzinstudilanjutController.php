...
use App\Kabagizinstudilanjut;
use Illuminate\Support\Facades\Validator;
use Illuminate\Http\Request;
use Illuminate\Support\Str;

class KabagIzinstudilanjutController extends Controller
{
    public $messages = [
    ...
    {
        $datas = Kabagizinstudilanjut::paginate(5);
        return view('kepalabagian.layanankarirkabag.kabagizinstudilanjut')->with(['datas' => $datas]);
    }
    /**
    ...
    {
        $delete = Kabagizinstudilanjut::where('nik_nip', $nik_nip)->delete();
