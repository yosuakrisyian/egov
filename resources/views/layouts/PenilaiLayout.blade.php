                ...
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a href="{{route('homePenilaiDaftarHitungSkp')}}">Perhitungan SKP</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a href="{{route('homePenilailihatperilakukerja')}}">Lihat Nilai Perilaku Kerja</a>
                            </li>
                            <li>
                                <a href="{{route('homePenilaiLihattpp')}}">Lihat TPP Pegawai</a>
                            </li>
                        </ul>
                    </li>  
                    <li>
